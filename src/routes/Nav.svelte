...
<nav
	class="fixed inset-x-0 z-10 flex h-header items-center justify-between border-b border-border bg-bg/50 px-[2ch] backdrop-blur-3xl [view-transition-name:nav] sm:px-8"
>
